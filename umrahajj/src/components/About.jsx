                            ...
                            <div className="about">
                                ...
                                <div className="image-content2">
					                <img src={require("../images/amanah.png")} className="img-responsive img2"/> 
                                        ...
                                        <p className="p10"> Only qualified and reliable umrah & hajj operators
                                        listed.</p>

				                        <img src={require("../images/syariah.png")} className="img-responsive img1"/>
                                            <b className="b1">Syariah</b>
                                            <p className="p4">Promoting a modest
                                                lifestyle among Gen-X and
                                                Millennials</p>
                                            <p className="p8">Beyond the umrah & hajj
                                                offering .</p>
